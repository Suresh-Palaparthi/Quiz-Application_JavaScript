...
const answerOptionsQ1 = [
  answerOptionFunctions,
  answerOptionXHTML,
  answerOptionCSS,
  answerOptionHTML,
];
...
const answerOptionsQ3 = [
  answerOptionPythonScript,
  answerOptionjQuery,
  answerOptionDjango,
  answerOptionNodeJS,
];
...
const answerOptionProgrammingLanguage = new AnswerOption(
  "Programming Language"
);
const answerOptionDevelopment = new AnswerOption("Development");

const answerOptionsQ5 = [
  answerOptionLanguage,
  answerOptionProgrammingLanguage,
  answerOptionDevelopment,
  answerOptionAll,
];
...
function QuizApplication(qAOptionsPairArray) {
  ...
  this.addListeners = function () {
    for (let index = 0; index <= 3; index++) {
      ...
      answerOptionButton.onclick = function (event) {
        ...
        const qaOptionsPair =
          currentQuizAppObject.qAOptionsPairArray[
  ...
  this.displayQASection = function () {
    ...
    for (let index = 0; index < 4; index++) {
      ...
      const answerChoiceHtmlButtonElement =
        document.getElementById(answerChoiceButtonId);

      answerChoiceHtmlButtonElement.innerHTML =
        qaOptionsPair.answerOptions[index].answerText;
    }
  };
  ...
  this.displayResultPage = function () {
    const finalScoreHtmlFragment = `<h1>Result</h1>
...
const qAOptionsPairArray = [
  questionAnswerOptionsPair1,
  questionAnswerOptionsPair2,
  questionAnswerOptionsPair3,
  questionAnswerOptionsPair4,
  questionAnswerOptionsPair5,
];
